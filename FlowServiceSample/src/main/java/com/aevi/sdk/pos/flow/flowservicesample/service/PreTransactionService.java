...
import com.aevi.sdk.pos.flow.flowservicesample.ui.PreTransactionActivity;
import com.aevi.sdk.pos.flow.model.TransactionRequest;
import com.aevi.sdk.pos.flow.service.BasePrePaymentService;

public class PreTransactionService extends BasePrePaymentService {

    @Override
    protected void processRequest(String clientMessageId, TransactionRequest transactionRequest) {
        launchActivity(PreTransactionActivity.class, clientMessageId, transactionRequest);
    }
